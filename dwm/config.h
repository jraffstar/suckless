...
static char normfloatcolor[]             = "#d8d2e2";
...
static char titlenormfloatcolor[]        = "#d8d2e2";
...
static char tagsnormfloatcolor[]         = "#d8d2e2";

static char tagsselfgcolor[]             = "#bd93f9";
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_e,     	   spawn,                  {.v = dolphincmd } },
	#if RIODRAW_PATCH
